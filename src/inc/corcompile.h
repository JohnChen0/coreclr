...
class ICorCompileInfo
{
  public:
    ...
    virtual DWORD GetVersionResilientTypeHashCode(CORINFO_MODULE_HANDLE moduleHandle, mdToken token) = 0;

    virtual DWORD GetVersionResilientMethodHashCode(CORINFO_METHOD_HANDLE methodHandle) = 0;
#endif
